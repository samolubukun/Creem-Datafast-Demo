...
const styles = {
  main: {
    minHeight: '100vh',
    padding: '4rem 2rem',
    background: 'radial-gradient(circle at 0% 0%, rgba(16,185,129,0.08) 0%, transparent 40%), #030712',
  },
  card: {
    maxWidth: 600,
    margin: '0 auto',
...
function getTrackingFromCookies() {
...
export default function PaymentSuccessPage() {
  ...
  useEffect(() => {
    ...
    const cookieTracking = getTrackingFromCookies();
    setTracking({
      visitorId: vid || cookieTracking.visitorId,
      sessionId: sid || cookieTracking.sessionId,
    });
  }, [searchParams]);
    ...
    <main style={styles.main}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>
          Thanks for your purchase. Your transaction has been recorded and attributed to your DataFast visitor profile.
        </p>
          ...
          <div style={styles.attributionBox}>
            ...
            <div style={styles.attributionGrid}>
              <div style={styles.attributionItem}>
                <span style={styles.label}>Visitor ID</span>
                <span style={styles.value}>{tracking.visitorId}</span>
              </div>
              <div style={styles.attributionItem}>
                <span style={styles.label}>Session ID</span>
                <span style={styles.value}>{tracking.sessionId || 'N/A'}</span>
              </div>
              <div style={styles.attributionItem}>
                <span style={styles.label}>Status</span>
                <span style={{ ...styles.value, color: '#10b981' }}>Attributed</span>
              </div>
              <div style={styles.attributionItem}>
